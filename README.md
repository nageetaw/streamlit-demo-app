...
This is a simple **Emotion Classification Web App Using StreamLit**.  
It allows users to type text and detect emotions like joy, sadness, anger, fear, neutral, disgust, and surprise.
...
https://nageetaw-streamlit-demo-app-main-s3s2js.streamlit.app/



You can also create your own demo by following the steps below.
